...
\end{quote}
\hfill Giordano Bruno, {\it On the Infinite Universe and Worlds} (1584)
\end{comment}
...
\rev{though only in retrospect}. The detection of HD 114762b (``Latham
...
The pioneering work by \cite{1988ApJ...331..902C} calibrated their
...
the art of the field \rev{for each calibration method}. These two methods of
...
barrier to be breached a few years ago around 2010\rev{, extrapolating
from the previous progress}. Unfortunately,
...
and HET \rev{better for large} RV surveys. (2) Stellar activity
...
with multiple planets \citep{butler1999}, the first \rev{Earth-density}
