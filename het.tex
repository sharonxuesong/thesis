...
always land on the same pixels. \het\ does not \rev{(and probably cannot,
due to a lack of actuators on optical parts) perform these
procedures, to the best of our knowledge. The upgraded \het\ will have
actuators to enable adoption of the same spectrometer adjustment
routine as \keck.}
