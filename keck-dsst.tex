...
detrimental to planet search, because it has a large amplitude (m/s in
HD 185144 \keck\ data) and it manifests as spurious signals at a
period of one sidereal year and its harmonics. For example,
\cite{apfpaper} tentatively claims a planet candidate around HD
185144, with period of $\sim$308 days and a mass of 12 $\mearth$. They
show, in their Figure 16, a power spectrum/periodogram of the HD
185144 \keck\ RVs, with the dominant peak around 300 days. However,
the errors in the DSST can produce a spurious periodic signal just
like this, as shown by the red dashed lines in
...
% plot made by ~/Exo.../Keck.../simulate.../msplot.pro, plot_name='makefakedsst','chunkcomp'
\begin{figure}
\includegraphics[scale=0.3]{keck/scargle_185144_new.eps}
...
near 180 and 360 days are caused by systematics which correlates with
BCs. In the case of the simulated data, we know that this systematic
rises from the errors in the DSST because all other conditions are
